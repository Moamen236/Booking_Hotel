...
@section('content')
        ...
        <div id="rev-slider-1" class="rev_slider gradient-slider" style="display:none" data-version="5.4.5">
          <ul>
            ...
            <li data-transition="crossfade">
              <!-- MAIN IMAGE -->
              <img src="{{ asset("web/images/slider/slider1.jpg") }}" alt="Image" title="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina="">
              <!-- LAYER NR. 1 -->
              <h1
              ...
              <div
                ...
                style="z-index: 11;">
                <a class="btn" href="{{ route('booking.index') }}">
              ...
              <div
                ...
                data-frames='[{"delay":2400,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                style="z-index: 11;">
                <a class="btn" href="{{ route('contact-us') }}">
            ...
            <li data-transition="crossfade">
              <!-- MAIN IMAGE -->
              <img src="{{ asset("web/images/slider/slider3.jpg") }}" alt="Image" title="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina="">
              <!-- LAYER NR. 1 -->
              <div
                class="tp-caption tp-resizeme"
                data-x="center"
            ...
            <li data-transition="crossfade">
              <!-- MAIN IMAGE -->
              <img src="{{ asset("web/images/slider/slider13.jpg") }}" alt="Image" title="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina="">
              <!-- LAYER NR. 1 -->
              <div
                class="tp-caption tp-resizeme"
                data-x="center"
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="brand-info">
                <div class="inner">
                  <div class="content">
                    <img src="{{ asset("web/images/logo-big-transparent.svg") }}" width="100" alt="Image">
                    <div class="stars">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="{{ asset("web/images/rooms/single/single1.jpg") }}" class="img-fluid" alt="Image">
                  </a>
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="{{ asset("web/images/rooms/double/double.jpg") }}" class="img-fluid" alt="Image">
                  </a>
                  <div class="room-services">
                    <i class="fa fa-coffee" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Breakfast Included" data-original-title="Breakfast"></i>
                    <i class="fa fa-wifi" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Free WiFi" data-original-title="WiFi"></i>
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="{{ asset("web/images/rooms/deluxe/deluxe.jpg") }}" class="img-fluid" alt="Image">
                  </a>
                  <div class="room-services">
                    <i class="fa fa-coffee" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Breakfast Included" data-original-title="Breakfast"></i>
            ...
            <div class="col-lg-7 col-12">
              <div data-slider-id="services" class="services-owl owl-carousel">
                <figure class="gradient-overlay">
                  <img src="{{ asset("web/images/services/restaurant.jpg") }}" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Restaurant</h4>
                  </figcaption>
                </figure>
                <figure class="gradient-overlay">
                  <img src="{{ asset("web/images/services/spa.jpg") }}" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Spa</h4>
                  </figcaption>
                </figure>
                <figure class="gradient-overlay">
                  <img src="{{ asset("web/images/services/conference.jpg") }}" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Conference Room</h4>
                  </figcaption>
                </figure>
                <figure class="gradient-overlay">
                  <img src="{{ asset("web/images/services/swimming.jpg") }}" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Swimming Pool</h4>
                  </figcaption>
                </figure>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery1.jpg">
                  <img src="{{ asset("web/images/gallery/gallery1.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery2.jpg">
                  <img src="{{ asset("web/images/gallery/gallery2.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery3.jpg">
                  <img src="{{ asset("web/images/gallery/gallery3.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery4.jpg">
                  <img src="{{ asset("web/images/gallery/gallery4.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery5.jpg">
                  <img src="{{ asset("web/images/gallery/gallery5.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery6.jpg">
                  <img src="{{ asset("web/images/gallery/gallery6.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery7.jpg">
                  <img src="{{ asset("web/images/gallery/gallery7.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery8.jpg">
                  <img src="{{ asset("web/images/gallery/gallery8.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery9.jpg">
                  <img src="{{ asset("web/images/gallery/gallery9.jpg") }}" alt="Image">
                </a>
            ...
            <div class="gallery-item">
              <figure class="gradient-overlay image-icon">
                <a href="images/gallery/gallery10.jpg">
                  <img src="{{ asset("web/images/gallery/gallery10.jpg") }}" alt="Image">
                </a>
        ...
        <div class="container">
          ...
          <div class="owl-carousel testimonials-owl">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user1.jpg") }}">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user2.jpg") }}">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user3.jpg") }}">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user4.jpg") }}">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user5.jpg") }}">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user6.jpg") }}">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user7.jpg") }}">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user8.jpg") }}">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="{{ asset("web/images/users/user9.jpg") }}">
                </div>
                <div class="author">
      ...
      <!-- ========== RESTAURANT ========== -->
      <section class="restaurant image-bg parallax gradient-overlay op5" data-src="{{ asset("web/images/restaurant.jpg") }}" data-parallax="scroll" data-speed="0.3" data-mirror-selector=".wrapper" data-z-index="0">
        <div class="container">
          <div class="section-title">
              ...
              <div class="restaurant-menu-item">
                <div class="row">
                  <div class="col-lg-4 col-12">
                    <figure>
                      <img src="{{ asset("web/images/restaurant/restaurant1.jpg") }}" class="img-fluid " alt="Image">
                    </figure>
                  </div>
            ...
            <div class="col-md-6 col-sm-6 col-6">
              <div class="restaurant-menu-item">
                <div class="row">
                  <div class="col-lg-4 col-12">
                    <figure>
                      <img src="{{ asset("web/images/restaurant/restaurant2.jpg") }}" class="img-fluid" alt="Image">
                    </figure>
                  </div>
                  <div class="col-lg-8 col-12">
                    <div class="info">
          ...
          <div class="row">
              ...
              <div class="news-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="blog-post.html">
                    <img src="{{ asset("web/images/blog/blog-post1.jpg") }}" class="img-fluid" alt="Image">
                  </a>
                </figure>
                <div class="news-info">
                  <h4 class="title">
                  ...
                  <div class="post-meta">
                    <span class="author">
                      <a href="#"><img src="{{ asset("web/images/users/admin.jpg") }}" width="16" alt="Image">
                        JANE</a>
                    </span>
                    <span class="date">
            ...
            <div class="col-md-4">
              <div class="news-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="blog-post.html">
                    <img src="{{ asset("web/images/blog/blog-post2.jpg") }}" class="img-fluid" alt="Image">
                  </a>
                </figure>
                <div class="news-info">
                  <h4 class="title">
            ...
            <div class="col-md-4">
              <div class="news-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="blog-post.html">
                    <img src="{{ asset("web/images/blog/blog-post3.jpg") }}" class="img-fluid" alt="Image">
                  </a>
                </figure>
                <div class="news-info">
                  <h4 class="title">
      ...
      <!-- ========== VIDEO ========== -->
      <section class="video np parallax gradient-overlay op6" data-src="{{ asset("web/images/video.jpg") }}" data-parallax="scroll" data-speed="0.3" data-mirror-selector=".wrapper" data-z-index="0">
