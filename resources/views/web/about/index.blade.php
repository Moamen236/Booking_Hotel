            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="brand-info">
                  <div class="inner">
                    <div class="content">
                      <img src="{{ asset("web/images/logo-big.svg") }}" width="100" alt="Hotel Himara">
                      <div class="stars">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <figure class="gradient-overlay-hover image-icon">
                    <a href="{{ asset("web/images/services/restaurant.jpg") }}"><img src="{{ asset("web/images/services/restaurant.jpg") }}" alt="Image" class="img-fluid"></a>
                  </figure>
                </div>
                <!-- ITEM -->
                <div class="col-md-3">
                  <figure class="gradient-overlay-hover image-icon">
                    <a href="{{ asset("web/images/services/gym.jpg") }}"><img src="{{ asset("web/images/services/gym.jpg") }}" alt="Image" class="img-fluid"></a>
                  </figure>
                </div>
                <!-- ITEM -->
                <div class="col-md-3">
                  <figure class="gradient-overlay-hover image-icon">
                    <a href="{{ asset("web/images/services/spa.jpg") }}"><img src="{{ asset("web/images/services/spa.jpg") }}" alt="Image" class="img-fluid"></a>
                  </figure>
                </div>
                <!-- ITEM -->
                <div class="col-md-3">
                  <figure class="gradient-overlay-hover image-icon">
                    <a href="{{ asset("web/images/services/bar.jpg") }}"><img src="{{ asset("web/images/services/bar.jpg") }}" alt="Image" class="img-fluid"></a>
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row mb40">
              ...
              <div class="col-md-4">
                <div class="award-item">
                  <figure>
                    <img src="{{ asset("web/images/award1.svg") }}" class="img-fluid" alt="Image">
                    <figcaption>
                      #1 Global Choice
                    </figcaption>
                  </figure>
              ...
              <div class="col-md-4">
                <div class="award-item">
                  <figure>
                    <img src="{{ asset("web/images/award2.svg") }}" class="img-fluid" alt="Image">
                    <figcaption>
                      #2 Top Quality
                    </figcaption>
                  </figure>
              ...
              <div class="col-md-4">
                <div class="award-item">
                  <figure>
                    <img src="{{ asset("web/images/award3.svg") }}" class="img-fluid" alt="Image">
                    <figcaption>
                      #1 Genuine Quality
                    </figcaption>
                  </figure>
