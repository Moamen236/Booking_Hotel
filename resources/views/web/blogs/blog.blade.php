...
@section('content')
    ...
    <!-- BLOG POST COVER -->
      <div class="blog-post-cover gradient-overlay op5" data-src="{{ asset("web/images/blog/post/blog-full.jpg") }}" data-parallax="scroll" data-speed="0.3" data-mirror-selector=".wrapper" data-z-index="0">
        <div class="container inner">
          <h2 class="blog-post-title">10 TIPS FOR HOLIDAY TRAVEL</h2>
          <div class="blog-post-info">
            <img alt="" src="{{ asset("web/images/blog/users/user1.jpg") }}" class="author-avatar" width="16">
            <p>by
              <span>
                <a href="#">JANE Doe</a></span></p>
            <p>on
                ...
                <div class="details">
                  ...
                  <div class="row image-gallery">
                    <div class="col-md-3">
                      <figure>
                        <div class="gradient-overlay-hover image-icon sm">
                          <a href="{{ asset("web/images/blog/post/blog-post2.jpg") }}">
                            <img src="{{ asset("web/images/blog/post/blog-post2.jpg") }}" class="img-fluid">
                          </a>
                        </div>
                    ...
                    <div class="col-md-3">
                      <figure>
                        <div class="gradient-overlay-hover image-icon sm">
                          <a href="{{ asset("web/images/blog/post/blog-post3.jpg") }}">
                            <img src="{{ asset("web/images/blog/post/blog-post3.jpg") }}" class="img-fluid">
                          </a>
                        </div>
                        <figcaption>Image Caption</figcaption>
                      </figure>
                    ...
                    <div class="col-md-3">
                      <figure>
                        <div class="gradient-overlay-hover image-icon sm">
                          <a href="{{ asset("web/images/blog/post/blog-post4.jpg") }}">
                            <img src="{{ asset("web/images/blog/post/blog-post4.jpg") }}" class="img-fluid">
                          </a>
                        </div>
                        <figcaption>Image Caption</figcaption>
                      </figure>
                    ...
                    <div class="col-md-3">
                      <figure>
                        <div class="gradient-overlay-hover image-icon sm">
                          <a href="{{ asset("web/images/blog/post/blog-post5.jpg") }}">
                            <img src="{{ asset("web/images/blog/post/blog-post5.jpg") }}" class="img-fluid">
                          </a>
                        </div>
                        <figcaption>Image Caption</figcaption>
                      </figure>
